...
from app.crm.schemes import ListUserResponseSchema, UserGetRequestSchema, \
    UserGetResponseSchema, UserAddSchema, UserSchema
...
class GetUserView(View):
    @docs(tags=["crm"], summary="Get user", description="Get users from database")
